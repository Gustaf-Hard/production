...
<script src="includes/js/lessons_missing_manuscript.js"></script>
...
<div class="row col-md-12">
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="">Add manuscript</a></li>
        <li role="presentation"><a href="all_manuscripts.php">All manuscripts</a></li>
    </ul>
</div>
