...
<div class="row">
    ...
    <div class="col-sm-3 lesson_list_container">
        ...
        <div id="lesson_list" class="list-group">

            <a class="list-group-item lesson_item" id="lesson_item">
                <p>
                    <strong> MAH001 </strong>
                </p>
                <p>
                    <small>Demo lesson name </small>
                </p>
                <p>
                    <span class="label label-success">Swedish</span>
                    <i class="fa fa-arrows-h"></i>
                    <span class="label label-danger">English</span>
                </p>
                <span id="lesson_id" style="display: none"></span>
            </a>
